    ...
    <div className="flex flex-row-reverse gap-[48px] px-6">
      ...
      <FeedWrapper>
        <div className="flex w-full flex-col items-center">
          ...
          <h1 className="my-6 text-center text-2xl font-bold text-neutral-800 dark:text-foreground">Quests</h1>
              ...
              return (
                <div className="flex w-full items-center gap-x-4 border-t-2 p-4" key={quest.title}>
                  ...
                  <div className="flex w-full flex-col gap-y-2">
                    <p className="text-xl font-bold text-neutral-700 dark:text-foreground">{quest.title}</p>
