    ...
    <div className="flex flex-row-reverse gap-[48px] px-6">
        ...
        <div className="mt-4 rounded-xl border-2 border-slate-200 p-4">
          ...
          <div className="mt-4 space-y-3">
            {[1, 2, 3].map((i) => (
              <div
                key={i}
                className="flex h-16 w-full animate-pulse rounded-lg border-2 bg-neutral-100"
              />
            ))}
          </div>
        </div>
      ...
      <div className="flex w-full flex-col items-center">
        ...
        <div className="mb-5 flex w-full items-center justify-between border-b-2 pb-4 text-neutral-400 lg:z-50 lg:-mt-[28px] lg:pt-[28px]">
          <Loader className="[--loader-dot-size:6px] [--loader-inner-dot-size:4px] [--loader-inner-margin:2px] [--loader-size:24px]" />
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
              {[1, 2, 3, 4, 5, 6].map((i) => (
                <div
                  key={i}
                  className="h-28 w-full animate-pulse rounded-xl border-2 border-b-4 bg-neutral-100 p-4"
                />
              ))}
            </div>
          </div>
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
              {[1, 2, 3].map((i) => (
                <div
                  key={i}
                  className="h-32 w-full animate-pulse rounded-xl border-2 border-b-4 bg-neutral-100 p-6"
                />
              ))}
            </div>
          </div>
