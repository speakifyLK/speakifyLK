...
vi.mock("react-admin", () => ({
  ...
  BooleanField: (props: { source: string }) => (
    <span data-testid={`ra-boolean-field-${props.source}`} data-source={props.source} />
  ),
...
describe("ChallengeOptionsList", () => {
  ...
  it('renders a TextField for "text"', () => {
    render(<ChallengeOptionsList />);
    expect(screen.getByTestId("ra-text-field-text")).toHaveAttribute("data-source", "text");
  });
  ...
  it('renders a TextField for "imageSrc"', () => {
    render(<ChallengeOptionsList />);
    expect(screen.getByTestId("ra-text-field-imageSrc")).toHaveAttribute("data-source", "imageSrc");
  });

  it('renders a TextField for "audioSrc"', () => {
    render(<ChallengeOptionsList />);
    expect(screen.getByTestId("ra-text-field-audioSrc")).toHaveAttribute("data-source", "audioSrc");
  });
});
