...
describe("ChatBubble", () => {
  ...
  describe("user messages", () => {
    it("renders the message content", () => {
      render(
        <ChatBubble role="user" content="Hello world" timestamp={validDate} />
      );
    ...
    it("applies right-aligned (flex-row-reverse) layout", () => {
      const { container } = render(
        <ChatBubble role="user" content="Hi" timestamp={validDate} />
      );
  ...
  describe("assistant messages", () => {
    ...
    it("applies white bubble styling with green border", () => {
      render(
        <ChatBubble role="assistant" content="Test" timestamp={validDate} />
      );
      const bubble = screen.getByText("Test");
  ...
  describe("timestamps", () => {
    ...
    it("formats a valid string timestamp", () => {
      render(
        <ChatBubble role="user" content="msg" timestamp="2025-06-20T09:15:00" />
      );
