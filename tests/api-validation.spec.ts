...
test.describe("API — Quiz Generate Endpoint", () => {
  ...
  test("should reject unauthenticated POST with empty body", async ({
    request,
  }) => {
    const response = await request.post(QUIZ_API, {
      data: {},
  ...
  test("should reject unauthenticated POST with partial data", async ({
    request,
  }) => {
    const response = await request.post(QUIZ_API, {
      data: {
...
test.describe("API — Quiz Session Endpoint", () => {
  ...
  test("should reject unauthenticated GET with sessionId param", async ({
    request,
  }) => {
  ...
  test("should reject unauthenticated GET with invalid sessionId", async ({
    request,
  }) => {
...
test.describe("API — Courses CRUD (Admin Protected)", () => {
  ...
  test("should reject unauthenticated GET /api/courses", async ({
    request,
  }) => {
  ...
  test("should reject unauthenticated POST /api/courses", async ({
    request,
  }) => {
  ...
  test("should reject unauthenticated GET /api/courses/1", async ({
    request,
  }) => {
  ...
  test("should reject unauthenticated PUT /api/courses/1", async ({
    request,
  }) => {
  ...
  test("should reject unauthenticated DELETE /api/courses/1", async ({
    request,
  }) => {
...
test.describe("API — Units CRUD (Admin Protected)", () => {
  ...
  test("should reject unauthenticated GET /api/units/1", async ({
    request,
  }) => {
  ...
  test("should reject unauthenticated PUT /api/units/1", async ({
    request,
  }) => {
  ...
  test("should reject unauthenticated DELETE /api/units/1", async ({
    request,
  }) => {
...
test.describe("API — Lessons CRUD (Admin Protected)", () => {
  ...
  test("should reject unauthenticated GET /api/lessons", async ({
    request,
  }) => {
  ...
  test("should reject unauthenticated POST /api/lessons", async ({
    request,
  }) => {
  ...
  test("should reject unauthenticated GET /api/lessons/1", async ({
    request,
  }) => {
  ...
  test("should reject unauthenticated PUT /api/lessons/1", async ({
    request,
  }) => {
  ...
  test("should reject unauthenticated DELETE /api/lessons/1", async ({
    request,
  }) => {
...
test.describe("API — Challenges CRUD (Admin Protected)", () => {
  ...
  test("should reject unauthenticated GET /api/challenges", async ({
    request,
  }) => {
  ...
  test("should reject unauthenticated POST /api/challenges", async ({
    request,
  }) => {
  ...
  test("should reject unauthenticated GET /api/challenges/1", async ({
    request,
  }) => {
  ...
  test("should reject unauthenticated PUT /api/challenges/1", async ({
    request,
  }) => {
  ...
  test("should reject unauthenticated DELETE /api/challenges/1", async ({
    request,
  }) => {
...
test.describe("API — Challenge Options CRUD (Admin Protected)", () => {
  ...
  test("should reject unauthenticated GET /api/challengeOptions", async ({
    request,
  }) => {
  ...
  test("should reject unauthenticated POST /api/challengeOptions", async ({
    request,
  }) => {
  ...
  test("should reject unauthenticated GET /api/challengeOptions/1", async ({
    request,
  }) => {
  ...
  test("should reject unauthenticated PUT /api/challengeOptions/1", async ({
    request,
  }) => {
  ...
  test("should reject unauthenticated DELETE /api/challengeOptions/1", async ({
    request,
  }) => {
...
test.describe("API — General Error Handling", () => {
  test("should return error for non-existent API routes", async ({
    request,
  }) => {
  ...
  test("should return error for non-existent nested API routes", async ({
    request,
  }) => {
  ...
  test("should reject request with unexpected content type", async ({
    request,
  }) => {
...
test.describe("API — Response Headers", () => {
  test("API responses should include content-type header", async ({
    request,
  }) => {
  ...
  test("protected API endpoints should return consistent non-200 status", async ({
    request,
  }) => {
    const endpoints = [
    ...
    for (const endpoint of endpoints) {
      ...
      expect(
        response.ok(),
        `${endpoint.method} ${endpoint.url} should not be ok`
      ).toBe(false);
    }
  });
});
